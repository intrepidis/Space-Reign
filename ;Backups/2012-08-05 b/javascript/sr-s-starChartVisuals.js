(function (global) {
	...
	SR.starChartVisuals = (function () {
		...
		(function ENCLOSED_FIELDS() {
			...
			N.whiteCircleTex = THREE.ImageUtils.loadTexture(N.imgDir + 'white_circle.png');
		}
			());
		...
		(function EXPOSED_METHODS() {
			...
			X.resize = function () {
				...
				N.camera = new THREE.PerspectiveCamera(SR.fixedSettings.cameraAngle, N.winSize.x / N.winSize.y, SR.fixedSettings.cameraNear, SR.fixedSettings.cameraFar);
				N.camera.position.x = cameraPos.x;
				N.camera.position.y = cameraPos.y;
			...
			X.getObjectsInScreenRegion = function (screenPos, size) {
				...
				*/
				...
				foundObjects =
					SR.solars.getSolarsInRegion(bounds)
