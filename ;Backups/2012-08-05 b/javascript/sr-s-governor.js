	...
	SR.governor = (function () {
		...
		function doTasks() {
			...
			if (reproportioningCountdown === 0) {
				...
				// Reset the counter.
				reproportioningCountdown = SR.fixedSettings.numItersToWait;
				...
				var portionMultiplier = (function () {
					...
					timeMargin = timeAllowance * SR.fixedSettings.timeMarginMultiplier;
					...
					if (halfP > SR.fixedSettings.minMarginFraction) {
						return halfP;
					}
					
					return SR.fixedSettings.minMarginFraction;
				}
					());
